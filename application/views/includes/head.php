		...
		<nav class='white' role="navigation">
			<div class="nav-wrapper container"><a id="logo-container" href="<?php echo base_url();?>home" class="brand-logo black-text center">AirCargo</a>
				<ul class="right hide-on-med-and-down black-text">
					<li><a class="black-text dropdown-button" data-activates="dropdown1" href="<?php echo base_url();?>login" >Welcome, Admin<i class="material-icons right">account_circle</i></a></li>
